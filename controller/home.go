...
type responsechecktoken struct {
	...
	Engine_multiplier_zona          float32     `json:"engine_multiplier_zona"`
	Engine_multiplier_jackpot       float32     `json:"engine_multiplier_jackpot"`
...
func CheckToken(c *fiber.Ctx) error {
	...
	if result.Client_status == 200 {
		return c.JSON(fiber.Map{
			...
			"engine_multiplier_zona":          result.Engine_multiplier_zona,
			"engine_multiplier_jackpot":       result.Engine_multiplier_jackpot,
